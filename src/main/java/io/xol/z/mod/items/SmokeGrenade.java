...
public class SmokeGrenade extends ItemThrowableGrenade {

	public SmokeGrenade(ItemDefinition type) {
		super(type, "smoke_grenade");
	}
	...
	class SmokeGrenadeItemRenderer extends ItemModelRenderer {
		...
		public SmokeGrenadeItemRenderer(ItemRenderer fallbackRenderer) {
			super(SmokeGrenade.this, fallbackRenderer, "./models/weapon/smoke_grenade/smoke_grenade.obj",
					"./models/weapon/smoke_grenade/smoke_grenade_albedo.png", "./textures/normalnormal.png", "./textures/defaultmaterial.png");
		}
