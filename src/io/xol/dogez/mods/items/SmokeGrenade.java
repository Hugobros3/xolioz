...
public class SmokeGrenade extends Item{
	...
	class SmokeGrenadeItemRenderer extends ObjViewModelRenderer{
		...
		public SmokeGrenadeItemRenderer(Item item) {
			super(item, "./entities/smoke_grenade/smoke_grenade.obj", "./entities/smoke_grenade/smoke_grenade_albedo.png", "./textures/normalnormal.png", "./textures/defaultmaterial.png");
		}
