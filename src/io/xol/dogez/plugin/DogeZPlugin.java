...
public class DogeZPlugin extends ServerPlugin {
	...
	public void onEnable() {
		...
		/*
		 * Weapon.init(this); Ammo.init(this); NMSTools.setMaxStackSize((332),
		 * 1);// Snowball/grenade nostack NMSTools.setMaxStackSize((344), 1);//
		 * egg/flash nostack NMSTools.setMaxStackSize((405), 1);// talkie-walkie
